...
namespace Project3902
{
    class AnimatedSprite : BaseSprite
    {
        ...
        public AnimatedSprite(SpriteAtlas atlas, Vector2 position, List<Rectangle> sourceRects, float frameTime, Vector2? scale = null)
            : base(atlas, position, new MultipleSource(sourceRects), scale)
        {
